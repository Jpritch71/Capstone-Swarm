...
public class Timer
{
    ...
    //public static Timer Register_Repeater(Timer timerIn, float duration, Action onComplete, Action<float> onUpdate = null,
    //    bool isLooped = false, bool useRealTime = false, MonoBehaviour autoDestroyOwner = null)
    //{
    //    if(timerIn != null)
    //    {
    ...
    //    else
    //    {
    //        timerIn.ReuseTimer(onComplete, onUpdate,
    //        isLooped, useRealTime,  autoDestroyOwner);
    //    }
    ...
    //public void ReuseTimer(Action onComplete, Action<float> onUpdate = null,
    //    bool isLooped = false, bool useRealTime = false, MonoBehaviour autoDestroyOwner = null)
    //{
